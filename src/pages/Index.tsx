    ...
    >
      ...
      <div className="container mx-auto px-4 py-8 space-y-12">
        ...
        <div className="flex flex-col gap-4 justify-center mt-8 max-w-xs mx-auto" ref={bookingButtonsRef}>
          ...
          <Button
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:shadow-lg hover:scale-105 transition-all duration-200 h-10 px-4 py-2 flex-1"
            onClick={() => {
